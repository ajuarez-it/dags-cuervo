...
with DAG(
    ...
    with TaskGroup("TG_silver") as TG_silver:
                        ...
                        "container_overrides": [
                            {
                                ...
                                "args": ["test", "--select", "dbt_cuervo.staging.material.stg_layout_mcc"]
                            }
                        ]
                    },
                ...
                trigger_cloud_run_job_for_silver_layout_mcc = CloudRunExecuteJobOperator(
                    ...
                    overrides={
                        "container_overrides": [
                            {
                                "name": JOB_NAME,
                                "args": ["run", "--select", "dbt_cuervo.staging.material.stg_layout_mcc"],
                            }
                        ]
                    },
        ...
        trigger_cloud_run_job_test_silver_layout_mcc >> trigger_cloud_run_job_for_silver_layout_mcc
    ...
    with TaskGroup("TG_gold") as TG_gold:
        ...
        trigger_cloud_run_job_test_gold_layout_mcc >> trigger_cloud_run_job_for_gold_layout_mcc
    gold_test >> gold_run
