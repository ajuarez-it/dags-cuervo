...
with DAG(
    ...
    catchup=False,
    tags=["MCC", "AREAS_NIELSEN", "SILVER", "GOLD"],
    description="A DAG to trigger areas_nielsen Workflow with BigQuery, and Cloud Run jobs.",
) as dag:
    ...
    with TaskGroup("TG_silver") as TG_silver:
                        ...
                        "container_overrides": [
                            {
                                ...
                                "args": ["test", "--select", "dbt_cuervo.staging.requester.stg_d_areas_nielsen"]
                            }
                        ]
                    },
                ...
                trigger_cloud_run_job_for_silver_areas_nielsen = CloudRunExecuteJobOperator(
                    ...
                    overrides={
                        "container_overrides": [
                            {
                                "name": JOB_NAME,
                                "args": ["run", "--select", "dbt_cuervo.staging.requester.stg_d_areas_nielsen"],
                            }
                        ]
                    },
        ...
        trigger_cloud_run_job_test_silver_areas_nielsen >> trigger_cloud_run_job_for_silver_areas_nielsen
    ...
    with TaskGroup("TG_gold") as TG_gold:
        ...
        trigger_cloud_run_job_test_gold_areas_nielsen >> trigger_cloud_run_job_for_gold_areas_nielsen
    gold_test >> gold_run
