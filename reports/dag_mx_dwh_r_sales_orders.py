...
with DAG(
    ...
    with TaskGroup("Silver", default_args={'pool': 'emetrix'}) as TG_silver:
        trigger_cloud_run_job_build_silver_sales_orders = CloudRunExecuteJobOperator(
            task_id="trigger_cloud_run_job_build_silver_sales_orders",
            overrides={
                "container_overrides": [
                    {
                        "args": [
    ...
    with TaskGroup("Gold", default_args={'pool': 'emetrix'}) as TG_gold:
        trigger_cloud_run_job_build_gold_sales_orders = CloudRunExecuteJobOperator(
            task_id="sales_orders_gold",
            overrides={
                "container_overrides": [
                    {
                        "args": [
